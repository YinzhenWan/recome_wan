...
class AliasSample(object):
    def __init__(self, ratio_list):
        ...
        while small and large:
            ...
            ratio_list[large_idx] -= (1 - ratio_list[small_idx]) #small不足1的部分由large来填充
            if ratio_list[large_idx] < 1.0:  # large分割出去一部分后如果自身比1还小则进入small栈
                small.append(large_idx)
            elif ratio_list[large_idx] > 1.0: # 如果比1还大再放回large栈
