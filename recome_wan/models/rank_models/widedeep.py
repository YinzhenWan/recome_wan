...
from recome_wan.models.layers import EmbeddingLayer, MLP_Layer, LR_Layer
from recome_wan.models.utils import get_dnn_input_dim,get_linear_input
...
class WideDeep(nn.Module):
    ...
    def forward(self, data: dict, is_training: bool = True) -> dict:
        ...
        # wide部分
        lr_logit = self.lr(sparse_embedding)  # linear contribution
        ...
        # Output
        y_pred = torch.sigmoid(lr_logit + dnn_output)  # Final prediction
        if is_training:
