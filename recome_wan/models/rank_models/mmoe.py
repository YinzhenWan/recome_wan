...
from recome_wan.models.utils import get_linear_input, get_dnn_input_dim, get_feature_num
...
class MMOE(nn.Module):
    ...
    def forward(self, data):
        ...
        dense_fea = get_linear_input(self.enc_dict,
                                     data)  # hidden = self.num_sparse_fea * self.embedding_dim + self.num_dense_fea
